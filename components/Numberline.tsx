...
export default function Numberline(props: any) {
  return (
    <div className={`relative ${props.className}`}>
      ...
      <div
        className="flex justify-between w-full absolute top-0 -mt-7 text-3xl"
        id="balls"
      >
        <div
          className={`rounded-full h-16 w-16 flex justify-center items-center transition-all ${
            props.value >= 0
